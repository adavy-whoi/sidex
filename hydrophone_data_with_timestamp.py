...
## Importing timestamp method
from convert_tstamps import get_sidex_tstamp_from_filename

## calling get_sidex_tstamp_from_filename
filename, timestamp = get_sidex_tstamp_from_filename(filename='./Sidex_20200127T235718p525826.txt')
## print out
print('=============================================')
print('---> using filename, timestamp')
print(' Filename:  {}'.format(filename))
print(' Timestamp: {}'.format(timestamp))
print('=============================================')

## another way to do it
val = get_sidex_tstamp_from_filename(filename='./Sidex_20200127T235718p525826.txt')
## print out
print('---> using val[0], val[1]')
